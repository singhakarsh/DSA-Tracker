...
//         <Routes>
//           <Route exact path="" element={count <= 99 ? <Lister
...
// Reducer function for managing checkbox states
...
function App() {
  ...
  // Function to handle checkbox state updates
  const handleCheckboxChange = (key, value) => {
    dispatch({ type: 'TOGGLE_CHECKBOX', payload: { key, value } });
  };
    const arrayq = [
    {
      ID: "1",
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          {/* Array of routes for different categories */}
          {[
            { path: "/Array and string", key: "Checked12", name: "Array", qlist: arrayq, no: "12" },
            { path: "/Greedy", key: "Checked1", name: "Greedy", qlist: greedyq, no: "1" },
            { path: "/Dp", key: "Checked2", name: "Dp", qlist: dpq, no: "2" },
            { path: "/Binary search", key: "Checked3", name: "Binary Search", qlist: Bsq, no: "3" },
            { path: "/Heaps", key: "Checked4", name: "Heap", qlist: heapq, no: "4" },
            { path: "/Recursion", key: "Checked5", name: "Recursion", qlist: recursionq, no: "5" },
            { path: "/Linked list", key: "Checked6", name: "Linked List", qlist: llq, no: "6" },
            { path: "/Binary Tree", key: "Checked7", name: "Binary Tree", qlist: Btq, no: "7" },
            { path: "/Binary Search Tree", key: "Checked8", name: "Binary Search Tree", qlist: Bstq, no: "8" },
            { path: "/Stack and Queue", key: "Checked9", name: "Stack and Queue", qlist: Sqtq, no: "9" },
            { path: "/Backtracking", key: "Checked10", name: "Backtracking", qlist: Backtrackingq, no: "10" },
            { path: "/Graphs", key: "Checked11", name: "Graphs", qlist: Graphq, no: "11" }
          ].map(({ path, key, name, qlist, no }) => (
            <Route
              key={path}
              path={path}
              element={
                <Questions
                  ...
                  no={no}
                  setChecked={(value) => handleCheckboxChange(key, value)}
                  qlist={qlist}
                  name={name}
                />
              }
