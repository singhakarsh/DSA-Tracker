    ...
    return (
        <div className="lister-container">
            ...
            <div className="progress-bar-container">
                <div className="filler" style={{ width: `${progressPercentage}%` }}>
                    <span className="label">{`${progressPercentage}%`}</span>
                </div>
            </div>
            <div style={{ height: "5vh" }}></div>
            <div className="cards-container">
                {[
                    { qno: 23, no: "12", name: "Array and String", Checked: Checked12 },
                    { qno: 5, no: "1", name: "Greedy", Checked: Checked1 },
                    { qno: 13, no: "2", name: "Dp", Checked: Checked2 },
                    { qno: 7, no: "3", name: "Binary search", Checked: Checked3 },
                    { qno: 5, no: "4", name: "Heaps", Checked: Checked4 },
                    { qno: 6, no: "5", name: "Recursion", Checked: Checked5 },
                    { qno: 8, no: "6", name: "Linked List", Checked: Checked6 },
                    { qno: 8, no: "7", name: "Binary Tree", Checked: Checked7 },
                    { qno: 6, no: "8", name: "Binary Search Tree", Checked: Checked8 },
                    { qno: 7, no: "9", name: "Stack and Queue", Checked: Checked9 },
                    { qno: 6, no: "10", name: "Backtracking", Checked: Checked10 },
                    { qno: 6, no: "11", name: "Graphs", Checked: Checked11 }
                ].map(({ qno, no, name, Checked }) => (
                    <Card
                        key={no}
                        qno={qno}
                        no={no}
